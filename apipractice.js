 ...
 * */ 
 ...
 async function getBradData() {
    const responseFromGithub = await fetch(`${githubUrl}bradripple`); // {object}
...
async function getSharleneData() {
    const responseFromGithub = await fetch(`${githubUrl}SharleneImperial`); // {object}
...
const getBothData2 = async function () {
    let x = await getBradData(); // {object} - name, html_url, public_repos
    console.log('X THIS IS THE SECOND X:', x);
    console.log('before y')
    let y = await getSharleneData(); // {object}
    console.log('AFTER Y THIS IS AFTER THE SECOND Y:')
    console.log('y:', y);
}
// Run 🏎 -> f
getBothData2();
...
async function getRomeData() {
    const responseFromGithub = await fetch(`${githubUrl}romebell`); // {object}
...
async function getQuinData() {
    const responseFromGithub = await fetch(`${githubUrl}qmsparks`); // {object}
...
const getBothData3 = async function () {
    let x = await getRomeData(); // {object} - name, html_url, public_repos
    console.log('X THIS IS THE THIRD X:', x);
    console.log('before y')
    let y = await getQuinData(); // {object}
    console.log('AFTER Y THIS IS AFTER THE THIRD Y:')
    console.log('y:', y);
}
// Run 🏎 -> f
getBothData3();
